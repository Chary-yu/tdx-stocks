...
class FactorCatalogTest(unittest.TestCase):
    ...
    def test_parser_contains_factors_and_quality_report_commands(self) -> None:
        parser = build_parser()
        args = parser.parse_args(["query", "factors"])
        self.assertEqual(args.command, "query")
        self.assertEqual(args.query_command, "factors")
        args = parser.parse_args(["query", "factor", "rs_score"])
        self.assertEqual(args.query_command, "factor")
        self.assertEqual(args.factor, "rs_score")
        args = parser.parse_args(["query", "rank", "rs_score", "--as-of", "latest"])
        self.assertEqual(args.query_command, "rank")
        self.assertEqual(args.factor, "rs_score")
