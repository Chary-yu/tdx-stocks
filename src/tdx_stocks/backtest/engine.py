...
def _run_backtest_vectorized(
    ...
    return _build_report_from_matches(strategy_name, params, trading_dates, periods_input, matches)
...
def _build_report_from_matches(
    ...
    return _build_report(strategy_name, params, trading_dates, periods, trades, equity_curve, empty_period_count, equity)
...
def _build_report(
    ...
    *,
    ...
    return BacktestReport(
        ...
        max_drawdown=max_drawdown([entry["equity"] / base_equity for entry in equity_curve]) if base_equity > 0 else 0.0,
        win_rate=win_rate,
