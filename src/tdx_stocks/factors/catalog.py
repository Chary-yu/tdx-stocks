...
FACTOR_CATALOG: tuple[FactorDefinition, ...] = (
    FactorDefinition("rank_ret_20", "xsec", "20日收益横截面排名", ("ret_20",)),
    FactorDefinition("rank_ret_60", "xsec", "60日收益横截面排名", ("ret_60",)),
    ...
    FactorDefinition("risk_score", "risk", "综合风险评分", ("vol_20", "atr_pct_14", "rsi_14")),
    FactorDefinition("is_high_volatility", "risk", "高波动标记", ("vol_20", "atr_pct_14")),
    FactorDefinition("missing_price_flag", "quality", "缺失价格标记", ("adj_open", "adj_high", "adj_low", "adj_close")),
    FactorDefinition("zero_amount_flag", "quality", "零成交额标记", ("amount", "amount_ma20")),
    FactorDefinition("invalid_ohlc_flag", "quality", "OHLC 异常标记", ("adj_open", "adj_high", "adj_low", "adj_close")),
    FactorDefinition("stale_price_flag", "quality", "价格停滞标记", ("adj_close", "volume")),
    FactorDefinition("extreme_return_flag", "quality", "极端收益标记", ("pct_chg", "ret_5")),
    FactorDefinition("low_history_flag", "quality", "历史长度不足标记", ("rn",)),
)
